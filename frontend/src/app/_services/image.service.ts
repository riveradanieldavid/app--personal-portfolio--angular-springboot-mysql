...
// REMOTE
// const baseUrl = 'http://pfaptest2.herokuapp.com/api/images';
// EDIT THIS PORT SHOULD BE SAME THAT "application.properties" (TOMCAT emmbebed server)
// LOCAL
const baseUrl = 'http://localhost:9090/api/images';
...
export class ImageService {
    ...
    findByFile(file: any): Observable<Image[]> {
        return this.http.get<Image[]>(`${baseUrl}?file=${file}`);
    }
}
